	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<form name="ch1">
				<p style="text-align:center; margin-bottom:20px;"><input type="checkbox" name="agreement1" value="" id="check">이용약관과 개인정보취급방침에 동의합니다.</p>

				<p style="text-align:center; margin-bottom:20px"><a href="#" onclick="check();"><img src="../images/btn01.gif" /></a>&nbsp;&nbsp;<a href="#"><img src="../images/btn02.gif" /></a></p>
				</form>	
				<script>
            var f = document.ch1;
            function check() {
               
               if(f.agreement1.checked==false){
                alert('약관동의를 하셔야합니다.');
                location.href = "../member/join01.jsp";
               }
               else{
