			...
			<div class="right_contents">
				...
				<div class="idpw_box">
					...
					<form action="id_search.jsp">
						...
						<a href=""><input type="image" src="../images/member/id_btn01.gif" class="id_btn" /></a>
					</form>	
						<a href="../member/join01.jsp"><input type="image" src="../images/login_btn03.gif" class="id_btn02" /></a>
					</div>
					
					<div class="pw_box">
						<form action="pw_search.jsp">
						<ul>
						...
						<a href=""><input type="image" src="../images/member/id_btn01.gif" class="pw_btn" /></a>
						</form>
					</div>
				</div>
			</div>
